        ...
        children: <Widget>[
          Column(
            ...
            children: [
              CryptoCard(
                selectedCrypto: 'BTC',
                btcInSelectedCurrency: isWaiting ? '?' : btcInSelectedCurrency,
                selectedCurrency: selectedCurrency,
              ),
              CryptoCard(
                selectedCrypto: 'ETH',
                btcInSelectedCurrency: isWaiting ? '?' : ethInSelectedCurrency,
                selectedCurrency: selectedCurrency,
              ),
              CryptoCard(
                selectedCrypto: 'LTC',
                btcInSelectedCurrency: isWaiting ? '?' : ltcInSelectedCurrency,
                selectedCurrency: selectedCurrency,
              ),
            ],
          ),
...
class CryptoCard extends StatelessWidget {
  const CryptoCard({
    super.key,
    required this.btcInSelectedCurrency,
    required this.selectedCurrency,
    required this.selectedCrypto,
  });

  final String btcInSelectedCurrency;
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Text(
            '1 $selectedCrypto = $btcInSelectedCurrency $selectedCurrency',
